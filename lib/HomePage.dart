...
import 'package:type_me/Chat.dart';
import 'Methods.dart';
  ...
  Widget build(BuildContext context){
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(onPressed: () => logOut(context) , icon: Icon(Icons.logout_rounded))
        ],
      ),
      body: isLoading? Center(child: Container(height:
      size.height / 20,
      width: size.width / 20,
